...
const variableSchemas = {
  ...
  PRACTICE_REFLECTION_REQUEST: optionalTextVariables(
    'weeklyCompletedPracticeCountText',
    'weeklyPlannedPracticeCountText',
    'weeklyCompletedMinutesText',
    'weeklyReflectionCountText',
    'totalCompletedPracticeCountText',
    'totalCompletedMinutesText',
  ),
  ...
  MEETING_REMINDER_1H: personalizedTextVariables(
    'startsAtText',
    'meetUrl',
    'weeklyCompletedPracticeCountText',
    'weeklyPlannedPracticeCountText',
  ...
  READING_REMINDER: personalizedTextVariables('readingTitle', 'readingUrl'),
  READING_COMPLETED_ACK: personalizedTextVariables('readingTitle'),
  DRAWING_SHARED: personalizedTextVariables('drawingTitle', 'drawingUrl'),
