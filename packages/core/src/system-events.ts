...
const variableSchemas = {
  ...
  MEETING_SERIES_SCHEDULED: textVariables('meetingScheduleSummary', 'meetUrl'),
  MEETING_SCHEDULED: personalizedTextVariables('startsAtText', 'meetUrl'),
  MEETING_REMINDER_24H: textVariables('startsAtText', 'meetUrl'),
  MEETING_REMINDER_1H: textVariables('startsAtText', 'meetUrl'),
  MEETING_RESCHEDULED: textVariables('previousStartsAtText', 'startsAtText', 'meetUrl'),
